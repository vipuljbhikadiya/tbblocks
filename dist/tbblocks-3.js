...
function edit(_ref) {
  ...
  const blockClass = classnames__WEBPACK_IMPORTED_MODULE_2___default()(`text text--align-${textAlign}`, `${colorClass}`, `${styleClass}`);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Styles', 'tbblocks'),
    initialOpen: true
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Text Color", "tbblocks"),
    className: 'ix-color-setting ix-color-top-0',
    colorSettings: [{
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Text Color')
    }]
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Alignment", "tbblocks"),
    options: [{
      value: "left",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Left", "tbblocks")
    }, {
      value: "center",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Center", "tbblocks")
    }, {
      value: "right",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Right", "tbblocks")
    }],
    value: textAlign,
    onChange: value => {
      setAttributes({
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Style", "tbblocks"),
    options: [{
      value: "one",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("One", "tbblocks")
    }, {
      value: "two",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Two", "tbblocks")
    }, {
      value: "three",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Three", "tbblocks")
    }, {
      value: "four",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Four", "tbblocks")
    }],
    value: textStyle,
    onChange: value => {
      setAttributes({
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Settings', 'tbblocks'),
    initialOpen: true
    ...
    onSplit: (value, isOriginal) => {
      ...
      const block = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__.createBlock)('tbblocks/paragraph', newAttributes);
    ...
    onReplace: onReplace,
    onRemove: onRemove,
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Paragraph text'),
    placeholder: placeholder || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Add text here...')
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./src/blocks/paragraph/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./save */ "./src/blocks/paragraph/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/paragraph/block.json");
...
function save(_ref) {
  ...
  const colorClass = textColorClass ? `text--color-${textColorClass}` : '';
  const styleClass = textStyle ? `text--style-${textStyle}` : '';
  const className = classnames__WEBPACK_IMPORTED_MODULE_1___default()(`text text--align-${textAlign}`, `${colorClass}`, `${styleClass}`);
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":2,"name":"tbblocks/paragraph","version":"0.1.5","title":"Paragraph","category":"theme","keywords":["paragraph","detail"],"description":"A gutenberg block to use for Paragraph.","supports":{"html":false,"anchor":true},"attributes":{"textAlign":{"type":"string","default":"left"},"content":{"type":"string","source":"html","selector":"p,span","default":""},"tag":{"type":"string","default":"p"},"placeholder":{"type":"string","default":"Add text here..."},"textColor":{"type":"string","default":"#343434"},"textColorClass":{"type":"string","default":"five"},"textStyle":{"type":"string","default":"one"}},"textdomain":"tbblocks","editorScript":"blocks-3.js"}');
...
/* harmony import */ var _blocks_paragraph__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./blocks/paragraph */ "./src/blocks/paragraph/index.js");
...
[_blocks_paragraph__WEBPACK_IMPORTED_MODULE_1__].forEach(_utils_helper__WEBPACK_IMPORTED_MODULE_0__.registerBlock);
}();
/******/ })()
;
//# sourceMappingURL=tbblocks-3.js.map