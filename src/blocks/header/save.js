                        ...
                        <ul className="header-contact--list">
                            { attributes.telefonLink != '' && attributes.telefon != '' ? 
                                <li class="header-contact--phone">
                                    <a href={attributes.telefonLink}><IconPhone />{attributes.telefon}</a>
                                </li>: ''
                            }
                            { attributes.emailLink != '' && attributes.email != '' ? 
                                <li class="header-contact--email">
                                    <a href={attributes.emailLink}><IconMail />{attributes.email}</a>
                                </li> : '' 
                            }        
                            { attributes.address != '' ? 
                                <li class="header-contact--address">
                                    <span><IconLocation /> {attributes.address}</span> 
                                </li>  : '' 
                            }
                        </ul>
                    </div> 
                    ...
                    <div className="header--nav">
                        <div class="site--logo">
                            <a href={attributes.site_url}>
                                <img src={sitelogo} alt="Tabler - High Tech Blech" />
                            </a>
                        </div>
                        <InnerBlocks.Content />
