 ...
 */
 import { IconPhoneline,  IconEnvelop, IconHome} from '../../../utils/block-icons';
                        ...
                        <div className="ci--list">
                            { attributes.emailLink != '' && attributes.email != '' ? 
                              <div class="ci--col bg--color-five">
                                <div class="ci--content">
                                    <div class="ci--icon"><IconEnvelop /></div>
                                    <div class="ci--info">
                                        <h3>E-Mail</h3>
                            ...
                            { attributes.address != '' ? 
                              <div class="ci--col bg--color-six">
                                <div class="ci--content">
                                    <div class="ci--icon"><IconHome /></div>
                                    <div class="ci--info">
                                        <h3>Adresse</h3>
                              ...
                              { attributes.telefonLink != '' && attributes.telefon != '' ? 
                                <div class="ci--col bg--color-seven">
                                    <div class="ci--content">
                                        <div class="ci--icon"><IconPhoneline /></div>
                                        <div class="ci--info">
                                            <h3>Telefon</h3>
