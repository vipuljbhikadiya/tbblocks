                                        ...
                                        return <div className='col-control-wrap' id={`col-${index}`}>
                                            { colResponsiveMode == item ?
                                                ...
                                                <div className='igb--row__settings'>
                                                    <SelectControl
                                                        label = {__("Alignment - Vertical", "tbblocks")}
                                                        options = {[
                                                            {
                                                                value: "",
                                                                label: __("Not Set", "tbblocks"),
                                                            },
                                                            {
                                                                value: "top",
                                                                label: __("Top", "tbblocks"),
                                                            },
                                                            {
                                                                value: "middle",
                                                                label: __("Middle", "tbblocks"),
                                                            },
                                                            {
                                                                value: "bottom",
                                                                label: __("Bottom", "tbblocks"),
                                                            },
                                                            {
                                                                value: "init",
                                                                label: __("Inherited", "tbblocks"),
                                                            }
                                                        ]}
                                                        value={ vAlign }
                            ...
                            colorSettings={[
                                {
                                    ...
                                    onChange: (value) => {
                                        ( typeof value == 'undefined' ) ? setAttributes({ colbgClass: '' }) : SetColorClass(value);
