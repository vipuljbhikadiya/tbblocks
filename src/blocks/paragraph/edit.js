...
export default function edit({ setAttributes, attributes, clientId, mergeBlocks, onReplace, onRemove }) {
    const { textAlign, content, tag, placeholder, textColorClass, textColor, textStyle } = attributes;
    ...
    const blockClass = classnames(`text text--align-${textAlign}`, `${colorClass}`, `${styleClass}`); 
        ...
        <div {...blockProps}>
                ...
                <PanelBody
                        ...
                        colorSettings={[
                            {
                                ...
                                value: textColor,
                                onChange: (value) => {
                                    ( typeof value == 'undefined' ) ? setAttributes({ textColorClass: '' }) : SetColorClass(value);
                    ...
                    <SelectControl
                        ...
                        options = {[
                            ...
                            {
                                value: "three",
                                label: __("Three", "tbblocks"),
                            },
                            {
                                value: "four",
                                label: __("Four", "tbblocks"),
                            },
                        ]}
                        value={textStyle}
                        onChange={ ( value ) => { 
            ...
            <RichText
                ...
                onSplit={ ( value, isOriginal ) => {
					...
					const block = createBlock( 'tbblocks/paragraph', newAttributes );
