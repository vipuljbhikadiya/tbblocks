...
export  const SmartphoneIcon = () => (
    <Icon
        icon={ () => (
            <svg xmlns="http://www.w3.org/2000/svg" width="11.92" height="19.37" viewBox="0 0 11.92 19.37">
            <g id="Group_146" data-name="Group 146" transform="translate(-8 -3)">
            <path id="Path_6" data-name="Path 6" d="M18.058,3h-8.2A1.863,1.863,0,0,0,8,4.863V20.508A1.863,1.863,0,0,0,9.863,22.37h8.2a1.863,1.863,0,0,0,1.863-1.863V4.863A1.863,1.863,0,0,0,18.058,3Zm1.118,17.508a1.118,1.118,0,0,1-1.118,1.118h-8.2a1.118,1.118,0,0,1-1.118-1.118V4.863A1.118,1.118,0,0,1,9.863,3.745h8.2a1.118,1.118,0,0,1,1.118,1.118Z" fill="#fff"/>
            <path id="Path_7" data-name="Path 7" d="M10,19.665h8.94V7H10Zm.745-11.92H18.2V18.92h-7.45Z" transform="translate(-0.51 -1.02)" fill="#fff"/>
            <rect id="Rectangle_8" data-name="Rectangle 8" width="3" height="1" transform="translate(12 4.37)" fill="#fff"/>
            </g>
            </svg>
        ) }
    />
